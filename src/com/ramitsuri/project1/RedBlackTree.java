...
public class RedBlackTree {
    ...
    private final Node nil = new Node(new Event(-1,-1));
    ...
    public void printTree(Node node) {
        ...
        printTree(node.left);
        System.out.print(((node.color==RED)?"Color: Red ":"Color: Black ")+"Key: "+node.event.ID+" Parent: "+node.parent.event.ID+"\n");
        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    item = scan.nextInt();
                    while (item != -999) {
                        node = new Node(new Event(item,item));
                        insert(node);
                        item = scan.nextInt();
                    }
                    printTree(root);
